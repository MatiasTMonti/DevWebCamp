...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input class="formulario__input" type="text" id="ponentes" name="ponentes" placeholder="Buscar Ponente"></input>
    ...
    <div class="formulario__campo">
        ...
        <input class="formulario__input" type="number" min="1" id="disponibles" name="disponibles" placeholder="Ejemplo 20" value="<?php echo $evento->disponibles; ?>"></input>
    </div>
</fieldset>